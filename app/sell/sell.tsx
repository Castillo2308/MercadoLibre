...
import { Upload, Sparkles, ShieldCheck, Truck } from 'lucide-react';
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleChange}
                          className="w-full rounded-xl border border-white/15 bg-white/5 px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-secondary"
                          required
                        >
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-white/75 mb-2">Imagenes (maximo 5)</label>
                      <div className="rounded-2xl border border-dashed border-white/25 bg-gradient-to-b from-white/10 to-white/5 p-8 text-center">
                        ...
                        <p className="text-white/70 mb-2">Arrastra archivos aqui o haz clic para seleccionar</p>
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row">
                    <Button
                      type="submit"
                      className="flex-1 rounded-xl border border-primary/40 bg-gradient-to-r from-[#1ed760] via-[#19c44f] to-[#13b249] py-3 font-bold text-[#052012] shadow-[0_12px_26px_rgba(29,184,73,0.42)] transition-all duration-300 hover:-translate-y-0.5 hover:brightness-110"
                    >
                      Publicar Producto
                    </Button>
                    <Button
            ...
            <motion.div {...sectionMotion} transition={{ duration: 0.45, delay: 0.15 }}>
              <Card className="rounded-2xl border border-white/12 bg-[#0c1d31]/90 p-5 text-white shadow-[0_18px_40px_rgba(0,0,0,0.3)]">
                ...
                <div className="mt-3 rounded-xl border border-white/10 bg-white/5 p-4">
                  ...
                  <p className="mt-1 text-xs text-white/55">{formData.category} · {formData.condition}</p>
                </div>
              </Card>
            </motion.div>
          </aside>
